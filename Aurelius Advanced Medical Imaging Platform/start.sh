...
echo ""
check_service "postgres" "http://localhost:5434" "PostgreSQL"
check_service "redis" "http://localhost:6379" "Redis"
check_service "gateway" "http://localhost:8200/health" "API Gateway"
check_service "imaging-svc" "http://localhost:8001/health" "Imaging Service"
check_service "ml-svc" "http://localhost:8002/health" "ML Service"
check_service "search-svc" "http://localhost:8004/health" "Search Service"
check_service "keycloak" "http://localhost:8180/health/ready" "Keycloak"
check_service "orthanc" "http://localhost:8042/system" "Orthanc"
check_service "minio" "http://localhost:9100/minio/health/live" "MinIO"
check_service "prometheus" "http://localhost:9190/-/healthy" "Prometheus"
check_service "grafana" "http://localhost:3101/api/health" "Grafana"
check_service "jaeger" "http://localhost:16686/" "Jaeger"
check_service "frontend" "http://localhost:3100" "Frontend"
...
echo "  📚 API Gateway:        http://localhost:8200"
...
echo "  🗂️  MinIO Console:      http://localhost:9101 (minioadmin/minioadmin)"
echo "  🏥 Orthanc:            http://localhost:8042 (orthanc/orthanc)"
echo "  📦 FHIR Server:        http://localhost:8183/fhir"
echo "  🔎 OpenSearch:         http://localhost:9300"
echo "  🤖 MLflow:             http://localhost:5100"
echo ""
echo "To view logs:"
